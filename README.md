...
- `HelloWorldFrame/IdentityCard`: framework prerequisites
- `HelloWorldFrame/HelloWorldModule.m`: CAA shared-library module
- `HelloWorldFrame/CNext/code/dictionary`: interface dictionary
- `HelloWorldFrame/CNext/resources/msgcatalog`: command and toolbar resources
